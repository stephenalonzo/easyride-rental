...
*/
        ...
        div.reservation-reminder>div>h2 {
            margin-bottom: var(--tw-size-2);
            font-size: 42px;
            font-weight: var(--tw-font-weight-bold);
            --tw-text-opacity: 1;
            color: rgb(var(--tw-color-zinc-800) / var(--tw-text-opacity));
        }

        div.reservation-reminder>div>p {
            margin-bottom: var(--tw-size-2);
            font-size: var(--tw-font-size-lg);
            line-height: var(--tw-line-height-7);
            --tw-text-opacity: 1;
            color: rgb(var(--tw-color-zinc-500) / var(--tw-text-opacity));
        }

        div.reservation-reminder>div>p>span {
            font-weight: var(--tw-font-weight-medium);
            --tw-text-opacity: 1;
            color: rgb(var(--tw-color-indigo-500) / var(--tw-text-opacity));
        }

        div.reservation-reminder>div>a {
            margin-top: var(--tw-size-3);
            display: inline-block;
            width: var(--tw-size-96);
            border-radius: var(--tw-border-radius-default);
            --tw-bg-opacity: 1;
            background-color: rgb(var(--tw-color-indigo-600) / var(--tw-bg-opacity));
            padding-left: var(--tw-size-5);
            padding-right: var(--tw-size-5);
            ...
            --tw-shadow-color: rgb(var(--tw-color-indigo-500) / 0.2);
            --tw-shadow: var(--tw-shadow-colored);
        }

        div.reservation-reminder>div>a:hover {
            --tw-bg-opacity: 1;
            background-color: rgb(var(--tw-color-indigo-700) / var(--tw-bg-opacity));
        }
    </style>
</head>
...
<body>
    <div class="reservation-reminder">
        <div>
            ...
            <p>Thank you for reserving with EasyRide Rental. Click the button below and you will be redirected to a page
